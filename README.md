...
ELEMENT  PP TYPE                          NAME                    USAGE                      REFERENCES
  ...
  F      LDA GTH (Goedecker)              F_GTH_LDA.psp           LMAX=P LOC=P ECUT=70 Ry     [6]
  F      BLYP GTH (Goedecker)             F_GTH_BLYP.psp          LMAX=P LOC=P ECUT=70 Ry     [6]
  F      PBE GTH (Ikeda-Boero)            F_GTH_PBE.psp           LMAX=P LOC=P ECUT=70 Ry
  ...
  Cd     PBE GTH (Ikeda-Boero)            Cd_GTH_PBE.psp          LMAX=D LOC=D ECUT=90 Ry    [62]
  ...
  In     BLYP GTH (Boero-Ikeda)           In-q13_GTH_BLYP.psp     LMAX=F LOC=F ECUT=90 Ry    [33]
  ...
  Pb     PBE GTH (Boero-Ikeda)            Pb_GTH_PBE.psp          LMAX=D LOC=D ECUT=90 Ry    [62]
...
[62] M. Boero, F. Pietrucci, W. Andreoni, J. Phys. Chem. B 129, 7340 (2025)

________________________________________________________________
Present update: 13 October 2025
________________________________________________________________
